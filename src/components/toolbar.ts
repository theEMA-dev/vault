...
export class ToolbarComponent extends LitElement {
  ...
  static styles = css`
    ...
    .toolbar > div#toolbar-sort .dropdown-container, .toolbar > div#toolbar-prefs .dropdown-container {
      left: auto;
      right: 0;
    }
    ...
    .dropdown-item:hover {
      background: var(--hx-background-400);
    }
    ...
    render() {
      return html`
        <div class="toolbar ${this.prefs.toolbarState === 'float' ? 'float' : ''}">
          <div id="toolbar-resolution" class="${this.activeDropdown === 'resolution' ? 'active' : ''}"
        ...
        <div class="dropdown-container">
          ...
          <div id="toolbar-aspect-ratio" class="${this.activeDropdown === 'aspectRatio' ? 'active' : ''}"  
        ...
        <div class="dropdown-container">
          <div class="dropdown-content">
            ...
            <div class="dropdown-item" @click=${(e: Event) => { e.stopPropagation(); this.handleCheckboxSelect('aspectRatio', option.value); }}>
          ...
          <div id="toolbar-sort" class="${this.activeDropdown === 'sortBy' ? 'active' : ''}"
           @click=${() => this.setActiveDropdown('sortBy')}>
        <span>Sort<br><span class="selections">${this.sortOptions.find(option => option.value === this.selectedValues.sortBy)?.label || ''}</span></span>
        <svg data-testid="geist-icon" height="16" stroke-linejoin="round" style="color: currentcolor;" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" clip-rule="evenodd" d="M14.0607 5.49999L13.5303 6.03032L8.7071 10.8535C8.31658 11.2441 7.68341 11.2441 7.29289 10.8535L2.46966 6.03032L1.93933 5.49999L2.99999 4.43933L3.53032 4.96966L7.99999 9.43933L12.4697 4.96966L13 4.43933L14.0607 5.49999Z" fill="currentColor"></path></svg>
        <div class="dropdown-container">
          <div class="dropdown-content">
          ...
          <div id="toolbar-prefs" class="${this.activeDropdown === 'prefs' ? 'active' : ''}"
